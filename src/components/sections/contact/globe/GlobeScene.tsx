...
export default function GlobeScene() {
  return (
    <div
      className='relative h-(--globe-mobile-size) w-(--globe-mobile-size) shrink-0 overflow-visible sm:h-(--globe-tablet-size) sm:w-(--globe-tablet-size) lg:h-(--globe-desktop-size) lg:w-(--globe-desktop-size)'
